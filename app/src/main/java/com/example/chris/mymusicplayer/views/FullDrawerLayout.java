...
public class FullDrawerLayout extends DrawerLayout {
     ...
     * @return true if the child view's gravity is set to NO_GRAVITY, false otherwise.
     */
    ...
    /**
     * @param child the child view.
     * @return the child view's gravity.
     */
    ...
    /**
     * @param gravity the given gravity value.
     * @return the gravity value as a string.
     */
